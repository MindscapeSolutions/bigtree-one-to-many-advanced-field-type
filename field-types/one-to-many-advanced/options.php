...
<fieldset>
	<label>Title Field 2 (Optional)</label>
	<span data-name="title_column_2" class="pop-dependant table">
		<? if ($data["table"]) { ?>
        <select name="title_column_2"><? BigTree::getFieldSelectOptions($data["table"],$data['title_column_2']) ?></select>
		<? } else { ?>
		<input type="text" disabled="disabled" value="Please select &quot;Table&quot;" />
		<? } ?>
	</span>
